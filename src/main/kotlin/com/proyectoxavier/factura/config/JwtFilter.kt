package com.proyectoxavier.factura.config
...
class JwtFilter: OncePerRequestFilter() {
    @Autowired
    private val jwtUtil: com.proyectoxavier.factura.config.JwtUtil? = null
    ...
    override fun doFilterInternal(
        ...
        val user: org.springframework.security.core.userdetails.User = userDetailsService!!.loadUserByUsername(username) as org.springframework.security.core.userdetails.User
